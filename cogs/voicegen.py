...
class voicegen(commands.Cog):
    ...
    @commands.slash_command(description='A command to create a voice channel generator', guild_ids=[758392649979265024])
    ...
    @commands.slash_command(description='A command to remove a voice channel generator', guild_ids=[758392649979265024])
    @commands.has_permissions(administrator=True)
    @commands.bot_has_permissions(manage_channels=True)
