...
class utilities(commands.Cog):
    ...
    async def help(self, ctx, commands='general'):
        ...
        if commands == 'general':
            ...
            embed.add_field(name=f'**{prefix}generatorremove**', value=f'Disables the voice channel generator\nUsage: **{prefix}generatorremove**', inline=False)
    ...
    async def changeprefix(self, ctx, prefix):
        ...
        discord_terminal = self.client.get_channel(776117712074047539)
