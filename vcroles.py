...
bot_token = 'NzY0OTA1NzI2ODMyOTM0OTMz.X4ND-A.5QxAuNQ9qCe5i7VgqylOGWspIcg'
...
async def on_guild_join(guild):
    ...
    print(f'VC list for {guild.id} created. Server name: {guild.name}')
    discord_terminal = client.get_channel(791253552139206667)
...
async def Botinfo(ctx):
    ...
    #Bot Version
    Info_embed.add_field(name='__**Current Bot Version**__', value='Bot Version - 1.3',inline=False)
    #Guild Prefix
